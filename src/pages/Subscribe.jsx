    ...
    <div className="">
      <div className="h-screen">
        <div className="flex flex-col justify-center items-center h-1/5 space-y-4">
          <h1 className="font-bold text-4xl">Subscription Plans</h1>
          <h3 className="flex flex-col justify-center items-center text-xl">
            <span>Pick Your Perfect Plan</span>
            <span>&</span>
            <span>Become Part of The TrackHammer Community</span>
          </h3>
        </div>
        <div
          name="container"
          className="flex items-center justify-center h-3/5"
        >
          <div className="flex-col items-center justify-center w-64 p-4 m-4 border-2 border-emerald-500 rounded-3xl h-5/6">
            <div
              name="title"
              className="flex items-center justify-center font-bold text-3xl h-1/6"
            >
              Free
            </div>
            <div
              name="price"
              className="flex items-center justify-center h-1/6"
            >
              <div className="font-bold text-emerald-500 text-4xl">$0</div>
              <div className="text-lg">/month</div>
            </div>
            <div
              name="services"
              className="flex flex-col items-center justify-center text-sm h-3/6"
            >
            ...
            <div
              name="button"
              className="flex items-center justify-center text-xl h-1/6 text-white"
            >
              <NavLink to="/login">
          ...
          <div className="flex-col items-center justify-center w-64 p-4 m-4 border-2 border-emerald-500 rounded-3xl h-5/6">
            ...
            <div
              ...
              className="flex items-center justify-center h-1/6"
            >
              <div className="font-bold text-emerald-500 text-4xl">$4.99</div>
              <div className="text-lg">/month</div>
            </div>
            <div
              name="services"
          ...
          <div className="flex-col items-center justify-center w-64 p-4 m-4 border-2 border-emerald-500 rounded-3xl h-5/6">
            ...
            <div
              ...
              className="flex items-center justify-center h-1/6"
            >
              <div className="font-bold text-emerald-500 text-4xl">$49.99</div>
